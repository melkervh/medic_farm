...
$pdf->startReport('Reporte de clientes registrados', 'Reporte de pedidos');
...
if ($dataClientes = $cliente->readAll()) {
    ...
    $pdf->cell(40, 10, utf8_decode('DUI'), 1, 0, 'C', 1);
    ...
    foreach ($dataClientes as $rowcliente) {
        ...
        if ($dataclientes = $cliente->readAll()) {
            ...
            $pdf->cell(35, 10, utf8_decode($rowcliente['nombre_cliente']), 1, 0,'C');
            $pdf->cell(35, 10, utf8_decode($rowcliente['apellido_cliente']), 1, 0,'C');
            $pdf->cell(40, 10, utf8_decode($rowcliente['dui_cliente']), 1, 0, 'C');
            $pdf->cell(70, 10, utf8_decode($rowcliente['correo_cliente']), 1, 1, 'C');
